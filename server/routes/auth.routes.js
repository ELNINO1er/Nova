...
import { z } from 'zod';
import { loginUser, phoneExists } from '../services/auth.service.js';
...
/* POST /api/auth/login — { phone, code } → JWT */
...
router.get('/me', (req, res) => {
  ...
  try {
    ...
    res.json({ id: payload.id, role: payload.role, patientId: payload.patientId });
  } catch {
